        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">User Articles</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <thead>
                  ...
                  while($arr = $res->fetch_assoc())
                      ...
                      <tr>
                        ...
                        <td><a href="user_a_delete.php?id=<?php echo $arr['ar_no']; ?>" onclick="return confirm('Do you want to delete?')">Delete</a></td>
                      </tr> 
                      <?php }?>
                  </tbody>
